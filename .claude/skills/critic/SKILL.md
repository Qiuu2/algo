...
<!-- ==========================================================================
  Claude Code skill wrapper. CONTENT BELOW IS THE VERBATIM critic skill from
  agents/critic/skill.md (source of record, v1.8 incl. §12 + battle record) --
  moved here only so teammates auto-load it. Not a rewrite; not a line deleted.
