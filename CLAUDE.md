...
> **⚠ R14/C9 状态更新（2026-06-04）**：R14 已 **CLOSED**、铁律八/C9 已 **RELEASED**（DEC-S4-R14-RULING-01 / DEC-S4-C9-RELEASE-01）。上条铁律八「R14 关闭前…不计入选型」**现仅约束未来 R14 类不可逆闸**；FIRA 收益现以 [L1] 进选型，但**须连体呈现 §8 未计入清单（43-379 MCPS）+ 官方锁 3.07x（3.13x 混 build 禁入）**。
